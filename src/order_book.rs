...
use crate::{
    ...
    types::{Execution, Order, Price, Side},
};

#[derive(Debug)]
pub struct OrderBook {
    pub symbol: String,
    pub buy_levels: BTreeMap<Reverse<Price>, PriceLevel>,
    pub sell_levels: BTreeMap<Price, PriceLevel>,
    pub order_map: HashMap<String, (Price, Side)>,
